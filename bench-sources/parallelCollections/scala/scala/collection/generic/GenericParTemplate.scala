    ...
    with HasNewCombiner[A, CC[A] @uncheckedVariance]
{
  ...
  protected override def newBuilder = newCombiner

  protected override def newCombiner = companion.newCombiner[A]
...
{
  protected override def newCombiner: Combiner[(K, V @uncheckedVariance), CC[K, V @uncheckedVariance]] = {
